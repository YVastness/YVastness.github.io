...
[![](https://labuladong.gitee.io/algo/images/others/leetcode.jpeg)](https://labuladong.gitee.io/algo/images/others/leetcode.jpeg)
...
[动态规划详解](https://labuladong.gitee.io/algo/di-er-zhan-a01c6/dong-tai-g-a223e/dong-tai-g-1e688/)说过凑零钱问题，暴力解法就是遍历一棵 N 叉树：
...
再看看回溯算法，后文 [回溯算法详解](https://labuladong.gitee.io/algo/di-san-zha-24031/bao-li-sou-96f79/hui-su-sua-c26da/) 干脆直接说了，回溯算法就是个 N 叉树的前后序遍历问题，没有例外。
...
这种思维是很重要的， [动态规划详解](https://labuladong.gitee.io/algo/di-er-zhan-a01c6/dong-tai-g-a223e/dong-tai-g-1e688/) 中总结的找状态转移方程的几步流程，有时候按照流程写出解法，可能自己都不知道为啥是对的，反正它就是对了。。。
...
-   [二分图判定算法](https://labuladong.gitee.io/algo/di-yi-zhan-da78c/shou-ba-sh-03a72/er-fen-tu--73400/)
-   [二叉树的递归转迭代的代码框架](https://labuladong.github.io/article/fname.html?fname=%e8%bf%ad%e4%bb%a3%e9%81%8d%e5%8e%86%e4%ba%8c%e5%8f%89%e6%a0%91)
-   [前缀树算法模板秒杀五道算法题](https://labuladong.gitee.io/algo/di-yi-zhan-da78c/shou-ba-sh-daeca/qian-zhui--46e56/)
-   [动态规划和回溯算法到底谁是谁爹？](https://labuladong.gitee.io/algo/di-er-zhan-a01c6/bei-bao-le-34bd4/dong-tai-g-35341/)
...
-   [存储系统设计之 LSM 树原理](https://labuladong.gitee.io/algo/di-si-zhan-4baf4/cun-chu-xi-f8588/)
...
-   [算法时空复杂度分析实用指南](https://labuladong.gitee.io/algo/di-ling-zh-bfe1b/suan-fa-sh-05f25/)
-   [题目不让我干什么，我偏要干什么](https://labuladong.gitee.io/algo/di-yi-zhan-da78c/shou-ba-sh-66994/ti-mu-bu-r-552fb/)
